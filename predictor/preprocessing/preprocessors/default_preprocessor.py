...
from predictor.preprocessing.cropping.cropping import crop_to_nonzero
from predictor.preprocessing.resampling.default_resampling import compute_new_shape
...
from predictor.utilities.utils import (
    ...
    def _normalize(
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(
                join(predictor.__path__[0], "preprocessing", "normalization"),
                scheme,
