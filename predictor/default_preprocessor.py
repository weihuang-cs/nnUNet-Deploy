...
from predictor.utilities import maybe_convert_to_dataset_name
from predictor.nnunet_utils.find_class_by_name import recursive_find_python_class
from predictor.utilities import PlansManager, ConfigurationManager
from predictor.utilities import get_filenames_of_train_images_and_targets
...
class DefaultPreprocessor(object):
    ...
    def _normalize(self, data: np.ndarray, seg: np.ndarray, configuration_manager: ConfigurationManager,
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(join(predictor.__path__[0], "preprocessing", "normalization"),
                                                           scheme,
                                                           'predictor.preprocessing.normalization')
