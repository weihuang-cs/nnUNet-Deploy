...
import predictor
from predictor.batchgenerators.utilities.file_and_folder_operations import join, maybe_mkdir_p, subfiles, load_json

from predictor.experiment_planning.dataset_fingerprint.fingerprint_extractor import DatasetFingerprintExtractor
from predictor.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
from predictor.experiment_planning.verify_dataset_integrity import verify_dataset_integrity
from predictor.paths import nnUNet_raw, nnUNet_preprocessed
from predictor.utilities.dataset_name_id_conversion import convert_id_to_dataset_name, maybe_convert_to_dataset_name
...
def extract_fingerprints(dataset_ids: List[int], fingerprint_extractor_class_name: str = 'DatasetFingerprintExtractor',
    ...
    """
    fingerprint_extractor_class = recursive_find_python_class(join(predictor.__path__[0], "experiment_planning"),
